...
LABEL maintainer="OpenSwoole Group <hello@openswoole.com>" version="1.0" license="MIT"
...
RUN set -ex \
    ...
    && apk add --no-cache php${PHP_VERSION:0:1}${PHP_VERSION:2:1}-opcache 2>/dev/null || true \
