...
#define OSW_TIMER_MIN_MICRO_SEC 1000
#define OSW_TIMER_MIN_MS 1
#define OSW_TIMER_MIN_SEC 0.001
#define OSW_TIMER_MAX_MS LONG_MAX
#define OSW_TIMER_MAX_SEC ((double) LONG_MAX / 1000)
