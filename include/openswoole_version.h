...
#define OPENSWOOLE_MAJOR_VERSION 26
#define OPENSWOOLE_MINOR_VERSION 2
#define OPENSWOOLE_RELEASE_VERSION 0
#define OPENSWOOLE_EXTRA_VERSION ""
#define OPENSWOOLE_VERSION "26.2.0"
#define OPENSWOOLE_VERSION_ID 260200
