...
#define OSW_WEBSOCKET_SEC_KEY_LEN 16
#define OSW_WEBSOCKET_GUID "258EAFA5-E914-47DA-95CA-C5AB0DC85B11"
#define OSW_WEBSOCKET_HEADER_LEN 2
#define OSW_WEBSOCKET_MASK_LEN 4
#define OSW_WEBSOCKET_MASK_DATA "258E"
#define OSW_WEBSOCKET_EXT16_MAX_LEN 0xFFFF
#define OSW_WEBSOCKET_EXT16_LENGTH 0x7E
#define OSW_WEBSOCKET_EXT64_LENGTH 0x7F
#define OSW_WEBSOCKET_CLOSE_CODE_LEN 2
#define OSW_WEBSOCKET_CLOSE_REASON_MAX_LEN 125
#define OSW_WEBSOCKET_OPCODE_MAX openswoole::websocket::OPCODE_PONG
...
struct Frame {
    Header header;
    char mask_key[OSW_WEBSOCKET_MASK_LEN];
