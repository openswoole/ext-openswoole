--TEST--
openswoole_websocket_server: websocket with small data concurrency
--SKIPIF--
...
$pm->childFunc = function () use ($pm) {
    ...
    $serv->on('message', function (openswoole_websocket_server $server, openswoole_websocket_frame $frame) {
        if (mt_rand(0, 1)) {
