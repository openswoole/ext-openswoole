...
?>
--EXPECTF--
Warning: OpenSwoole\Server::send(): fd can not be null in %s/tests/openswoole_server/invalid_fd.php on line %d

Warning: OpenSwoole\Server::send(): invalid fd[-1] in %s/tests/openswoole_server/invalid_fd.php on line %d
