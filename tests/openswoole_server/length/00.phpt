--TEST--
openswoole_server/length: (length protocol) recv 100k packet
--SKIPIF--
<?php
...
require __DIR__ . '/../../include/api/openswoole_server/TestServer.php';
...
$pm->parentFunc = function ($pid) use ($pm) {
    $client = new openswoole_client(SWOOLE_SOCK_TCP);
