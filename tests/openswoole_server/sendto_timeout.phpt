--TEST--
openswoole_server: sendto timeout
--SKIPIF--
...
$pm->parentFunc = function ($pid) use ($pm) {
    $client = new OpenSwoole\Client(SWOOLE_SOCK_UNIX_DGRAM, OPENSWOOLE_SOCK_SYNC);
...
$pm->childFunc = function () use ($pm) {
    $serv = new openswoole_server(SOCK_FILE, 0, SWOOLE_BASE, SWOOLE_SOCK_UNIX_DGRAM);
