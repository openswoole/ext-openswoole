--TEST--
openswoole_server: addProcess with fatal error
--SKIPIF--
...
$pm->childFunc = function () use ($pm) {
    ...
    class Process4 extends OpenSwoole\Process
    {
...
Fatal error: ERROR in %s/tests/openswoole_server/addProcess_with_error.php on line %d
