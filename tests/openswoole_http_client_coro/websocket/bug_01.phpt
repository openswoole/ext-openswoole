--TEST--
openswoole_http_client_coro/websocket: handshake + frame
--SKIPIF--
...
{
    $ws = new openswoole_server('127.0.0.1', $pm->getFreePort(), SWOOLE_BASE);
    $ws->set(array(
        'log_file' => '/dev/null'
    ));
    ...
    $ws->on('receive', function ($serv, $fd, $threadId, $data) {
        ...
        $sendData .= openswoole_websocket_server::pack("hello world\n");
