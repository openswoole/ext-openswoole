--TEST--
openswoole_http_client_coro: http header field normal chars
--SKIPIF--
<?php
...
$pm->childFunc = function () use ($pm) {
    ...
    $server->on('request', function (openswoole_http_request $request, openswoole_http_response $response) use ($pm) {
        global $normal_chars;
