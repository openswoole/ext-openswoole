--TEST--
openswoole_http_server: http server callback use new object method
--SKIPIF--
...
$pm->childFunc = function () use ($pm) {
    ...
    class TestCo
    {
        public function foo(openswoole_http_request $request, openswoole_http_response $response)
        {
            Co::usleep(1000);
