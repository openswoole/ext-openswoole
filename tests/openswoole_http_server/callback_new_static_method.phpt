--TEST--
openswoole_http_server: http server callback use static method
--SKIPIF--
...
$pm->childFunc = function () use ($pm) {
    ...
    class TestCo
    {
        ...
        public static function foo(openswoole_http_request $request, openswoole_http_response $response)
        {
            Co::usleep(1000);
