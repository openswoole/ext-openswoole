...
if (pcntl_fork() === 0) {
    ...
    $cli->on("connect", function(openswoole_client $cli) {
        ...
        /*
        $cli->getSocket();
        // Warning: openswoole_client_async::getSocket(): unable to obtain socket family Error: Bad file descriptor[9].
        $cli->getSocket();
         */
...
class TcpServer
{
    ...
    {
        $this->swooleServer = new \openswoole_server(TCP_SERVER_HOST, TCP_SERVER_PORT, SWOOLE_PROCESS, SWOOLE_SOCK_TCP);
