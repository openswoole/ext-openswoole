...
$table->column('a', OpenSwoole\Table::TYPE_INT);
$table->column('b', OpenSwoole\Table::TYPE_FLOAT);
$table->column('c', OpenSwoole\Table::TYPE_STRING, 8);
$table->create();
try{
