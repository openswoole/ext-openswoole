--TEST--
openswoole_table: key-value operate
--SKIPIF--
...
$table->column('id', openswoole_table::TYPE_INT);
$table->column('name', openswoole_table::TYPE_STRING, 128);
$table->column('num', openswoole_table::TYPE_FLOAT);
