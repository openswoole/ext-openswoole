--TEST--
openswoole_table: clear all columns
--SKIPIF--
...
$table->column('state', OpenSwoole\Table::TYPE_INT);
$table->column('remainLen', OpenSwoole\Table::TYPE_INT);
$table->column('data', OpenSwoole\Table::TYPE_STRING, 64);
$table->create();
