...
$table->column('i8', openswoole_table::TYPE_INT, 1);
$table->column('i16', openswoole_table::TYPE_INT, 2);
$table->column('i32', openswoole_table::TYPE_INT, 4);
$table->column('i64', openswoole_table::TYPE_INT, 8);
