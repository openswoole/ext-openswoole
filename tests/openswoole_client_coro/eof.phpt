--TEST--
openswoole_client_coro: tcp client with eof
--SKIPIF--
...
{
    $http = new openswoole_http_server('127.0.0.1', $pm->getFreePort(0), SWOOLE_BASE);
    ...
    $http->on('request', function (openswoole_http_request $request, openswoole_http_response $response) use ($pm)
    {
