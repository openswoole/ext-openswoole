...
_replace_options(ROOT_DIR.'/ext-src/php_openswoole.cc', $php_content, 'GLOBAL_OPTIONS');
_replace_options(ROOT_DIR.'/ext-src/openswoole_server.cc', $php_content, 'SERVER_OPTIONS');
_replace_options(ROOT_DIR.'/ext-src/openswoole_server_port.cc', $php_content, 'PORT_OPTIONS');
