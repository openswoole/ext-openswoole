 ...
 * Stub hash: ff0ff72380506b74d3365710bcb757d6ff2b3f1e */
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_class_Swoole_Table_get,
                                        0,
                                        1,
                                        MAY_BE_ARRAY | MAY_BE_BOOL | MAY_BE_STRING | MAY_BE_LONG | MAY_BE_DOUBLE)
ZEND_ARG_TYPE_INFO(0, key, IS_STRING, 0)
