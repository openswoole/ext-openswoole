...
/* $Id: 9a154e7ecf0fa4b1f00d959834fd75e6e32c79ac */
...
static const char* swoole_library_source_vendor_init =
    "\n"
    "/**\n"
    " * This file is part of Open Swoole.\n"
    " *\n"
...
void php_swoole_load_library()
{
    ...
    zend::eval(swoole_library_source_vendor_init, "@swoole-src/library/vendor_init.php");
}
