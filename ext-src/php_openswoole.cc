...
PHP_MINIT_FUNCTION(openswoole) {
    ...
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_SOCK_TCP", OSW_SOCK_TCP);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_SOCK_TCP6", OSW_SOCK_TCP6);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_SOCK_UDP", OSW_SOCK_UDP);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_SOCK_UDP6", OSW_SOCK_UDP6);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_SOCK_UNIX_DGRAM", OSW_SOCK_UNIX_DGRAM);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_SOCK_UNIX_STREAM", OSW_SOCK_UNIX_STREAM);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_TCP", OSW_SOCK_TCP);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_TCP6", OSW_SOCK_TCP6);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_UDP", OSW_SOCK_UDP);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_UDP6", OSW_SOCK_UDP6);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_UNIX_DGRAM", OSW_SOCK_UNIX_DGRAM);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_UNIX_STREAM", OSW_SOCK_UNIX_STREAM);
    OSW_REGISTER_BOOL_CONSTANT("SWOOLE_SOCK_SYNC", 0);
    OSW_REGISTER_BOOL_CONSTANT("SWOOLE_SOCK_ASYNC", 1);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_SYNC", OSW_FLAG_SYNC);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ASYNC", OSW_FLAG_ASYNC);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_KEEP", OSW_FLAG_KEEP);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_SELECT", openswoole::Reactor::TYPE_SELECT);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_EPOLL", openswoole::Reactor::TYPE_EPOLL);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_KQUEUE", openswoole::Reactor::TYPE_KQUEUE);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_POLL", openswoole::Reactor::TYPE_POLL);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_IO_URING", openswoole::Reactor::TYPE_IO_URING);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_EVENT_READ", OSW_EVENT_READ);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_EVENT_WRITE", OSW_EVENT_WRITE);
#ifdef OSW_USE_OPENSSL
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_SSL", OSW_SOCK_SSL);
#endif
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_STRERROR_SYSTEM", OSW_STRERROR_SYSTEM);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_STRERROR_GAI", OSW_STRERROR_GAI);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_STRERROR_DNS", OSW_STRERROR_DNS);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_STRERROR_SWOOLE", OSW_STRERROR_SWOOLE);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_IPC_NONE", OSW_IPC_NONE);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_IPC_UNIXSOCK", OSW_IPC_UNIXSOCK);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_IPC_SOCKET", OSW_IPC_SOCKET);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_LOG_DEBUG", OSW_LOG_DEBUG);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_LOG_TRACE", OSW_LOG_TRACE);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_LOG_INFO", OSW_LOG_INFO);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_LOG_NOTICE", OSW_LOG_NOTICE);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_LOG_WARNING", OSW_LOG_WARNING);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_LOG_ERROR", OSW_LOG_ERROR);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_LOG_NONE", OSW_LOG_NONE);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_TRACE_ALL", OSW_TRACE_ALL);
    OSW_REGISTER_STRING_CONSTANT("SWOOLE_VERSION", OPENSWOOLE_VERSION);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_VERSION_ID", OPENSWOOLE_VERSION_ID);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_MAJOR_VERSION", OPENSWOOLE_MAJOR_VERSION);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_MINOR_VERSION", OPENSWOOLE_MINOR_VERSION);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_RELEASE_VERSION", OPENSWOOLE_RELEASE_VERSION);
    OSW_REGISTER_STRING_CONSTANT("SWOOLE_EXTRA_VERSION", OPENSWOOLE_EXTRA_VERSION);

    // SWOOLE_ERROR_* backward compatibility aliases
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_MALLOC_FAIL", OSW_ERROR_MALLOC_FAIL);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SYSTEM_CALL_FAIL", OSW_ERROR_SYSTEM_CALL_FAIL);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_PHP_FATAL_ERROR", OSW_ERROR_PHP_FATAL_ERROR);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_NAME_TOO_LONG", OSW_ERROR_NAME_TOO_LONG);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_INVALID_PARAMS", OSW_ERROR_INVALID_PARAMS);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_QUEUE_FULL", OSW_ERROR_QUEUE_FULL);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_OPERATION_NOT_SUPPORT", OSW_ERROR_OPERATION_NOT_SUPPORT);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_PROTOCOL_ERROR", OSW_ERROR_PROTOCOL_ERROR);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_WRONG_OPERATION", OSW_ERROR_WRONG_OPERATION);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_FILE_NOT_EXIST", OSW_ERROR_FILE_NOT_EXIST);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_FILE_TOO_LARGE", OSW_ERROR_FILE_TOO_LARGE);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_FILE_EMPTY", OSW_ERROR_FILE_EMPTY);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_DNSLOOKUP_DUPLICATE_REQUEST", OSW_ERROR_DNSLOOKUP_DUPLICATE_REQUEST);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_DNSLOOKUP_RESOLVE_FAILED", OSW_ERROR_DNSLOOKUP_RESOLVE_FAILED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_DNSLOOKUP_RESOLVE_TIMEOUT", OSW_ERROR_DNSLOOKUP_RESOLVE_TIMEOUT);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_DNSLOOKUP_UNSUPPORTED", OSW_ERROR_DNSLOOKUP_UNSUPPORTED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_DNSLOOKUP_NO_SERVER", OSW_ERROR_DNSLOOKUP_NO_SERVER);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_BAD_IPV6_ADDRESS", OSW_ERROR_BAD_IPV6_ADDRESS);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_UNREGISTERED_SIGNAL", OSW_ERROR_UNREGISTERED_SIGNAL);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_EVENT_SOCKET_REMOVED", OSW_ERROR_EVENT_SOCKET_REMOVED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SESSION_CLOSED_BY_SERVER", OSW_ERROR_SESSION_CLOSED_BY_SERVER);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SESSION_CLOSED_BY_CLIENT", OSW_ERROR_SESSION_CLOSED_BY_CLIENT);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SESSION_CLOSING", OSW_ERROR_SESSION_CLOSING);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SESSION_CLOSED", OSW_ERROR_SESSION_CLOSED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SESSION_NOT_EXIST", OSW_ERROR_SESSION_NOT_EXIST);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SESSION_INVALID_ID", OSW_ERROR_SESSION_INVALID_ID);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SESSION_DISCARD_TIMEOUT_DATA", OSW_ERROR_SESSION_DISCARD_TIMEOUT_DATA);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SESSION_DISCARD_DATA", OSW_ERROR_SESSION_DISCARD_DATA);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_OUTPUT_BUFFER_OVERFLOW", OSW_ERROR_OUTPUT_BUFFER_OVERFLOW);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_OUTPUT_SEND_YIELD", OSW_ERROR_OUTPUT_SEND_YIELD);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SSL_NOT_READY", OSW_ERROR_SSL_NOT_READY);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SSL_CANNOT_USE_SENFILE", OSW_ERROR_SSL_CANNOT_USE_SENFILE);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SSL_EMPTY_PEER_CERTIFICATE", OSW_ERROR_SSL_EMPTY_PEER_CERTIFICATE);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SSL_VERIFY_FAILED", OSW_ERROR_SSL_VERIFY_FAILED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SSL_BAD_CLIENT", OSW_ERROR_SSL_BAD_CLIENT);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SSL_BAD_PROTOCOL", OSW_ERROR_SSL_BAD_PROTOCOL);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SSL_RESET", OSW_ERROR_SSL_RESET);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SSL_HANDSHAKE_FAILED", OSW_ERROR_SSL_HANDSHAKE_FAILED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_PACKAGE_LENGTH_TOO_LARGE", OSW_ERROR_PACKAGE_LENGTH_TOO_LARGE);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_PACKAGE_LENGTH_NOT_FOUND", OSW_ERROR_PACKAGE_LENGTH_NOT_FOUND);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_DATA_LENGTH_TOO_LARGE", OSW_ERROR_DATA_LENGTH_TOO_LARGE);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_TASK_PACKAGE_TOO_BIG", OSW_ERROR_TASK_PACKAGE_TOO_BIG);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_TASK_DISPATCH_FAIL", OSW_ERROR_TASK_DISPATCH_FAIL);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_TASK_TIMEOUT", OSW_ERROR_TASK_TIMEOUT);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_HTTP2_STREAM_ID_TOO_BIG", OSW_ERROR_HTTP2_STREAM_ID_TOO_BIG);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_HTTP2_STREAM_NO_HEADER", OSW_ERROR_HTTP2_STREAM_NO_HEADER);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_HTTP2_STREAM_NOT_FOUND", OSW_ERROR_HTTP2_STREAM_NOT_FOUND);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_HTTP2_STREAM_IGNORE", OSW_ERROR_HTTP2_STREAM_IGNORE);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_AIO_BAD_REQUEST", OSW_ERROR_AIO_BAD_REQUEST);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_AIO_CANCELED", OSW_ERROR_AIO_CANCELED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_AIO_TIMEOUT", OSW_ERROR_AIO_TIMEOUT);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CLIENT_NO_CONNECTION", OSW_ERROR_CLIENT_NO_CONNECTION);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SOCKET_CLOSED", OSW_ERROR_SOCKET_CLOSED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SOCKET_POLL_TIMEOUT", OSW_ERROR_SOCKET_POLL_TIMEOUT);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SOCKS5_UNSUPPORT_VERSION", OSW_ERROR_SOCKS5_UNSUPPORT_VERSION);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SOCKS5_UNSUPPORT_METHOD", OSW_ERROR_SOCKS5_UNSUPPORT_METHOD);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SOCKS5_AUTH_FAILED", OSW_ERROR_SOCKS5_AUTH_FAILED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SOCKS5_SERVER_ERROR", OSW_ERROR_SOCKS5_SERVER_ERROR);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SOCKS5_HANDSHAKE_FAILED", OSW_ERROR_SOCKS5_HANDSHAKE_FAILED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_HTTP_PROXY_HANDSHAKE_ERROR", OSW_ERROR_HTTP_PROXY_HANDSHAKE_ERROR);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_HTTP_INVALID_PROTOCOL", OSW_ERROR_HTTP_INVALID_PROTOCOL);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_HTTP_PROXY_HANDSHAKE_FAILED", OSW_ERROR_HTTP_PROXY_HANDSHAKE_FAILED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_HTTP_PROXY_BAD_RESPONSE", OSW_ERROR_HTTP_PROXY_BAD_RESPONSE);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_WEBSOCKET_BAD_CLIENT", OSW_ERROR_WEBSOCKET_BAD_CLIENT);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_WEBSOCKET_BAD_OPCODE", OSW_ERROR_WEBSOCKET_BAD_OPCODE);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_WEBSOCKET_UNCONNECTED", OSW_ERROR_WEBSOCKET_UNCONNECTED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_WEBSOCKET_HANDSHAKE_FAILED", OSW_ERROR_WEBSOCKET_HANDSHAKE_FAILED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_WEBSOCKET_PACK_FAILED", OSW_ERROR_WEBSOCKET_PACK_FAILED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SERVER_MUST_CREATED_BEFORE_CLIENT", OSW_ERROR_SERVER_MUST_CREATED_BEFORE_CLIENT);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SERVER_TOO_MANY_SOCKET", OSW_ERROR_SERVER_TOO_MANY_SOCKET);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SERVER_WORKER_TERMINATED", OSW_ERROR_SERVER_WORKER_TERMINATED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SERVER_INVALID_LISTEN_PORT", OSW_ERROR_SERVER_INVALID_LISTEN_PORT);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SERVER_TOO_MANY_LISTEN_PORT", OSW_ERROR_SERVER_TOO_MANY_LISTEN_PORT);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SERVER_PIPE_BUFFER_FULL", OSW_ERROR_SERVER_PIPE_BUFFER_FULL);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SERVER_NO_IDLE_WORKER", OSW_ERROR_SERVER_NO_IDLE_WORKER);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SERVER_ONLY_START_ONE", OSW_ERROR_SERVER_ONLY_START_ONE);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SERVER_SEND_IN_MASTER", OSW_ERROR_SERVER_SEND_IN_MASTER);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SERVER_INVALID_REQUEST", OSW_ERROR_SERVER_INVALID_REQUEST);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SERVER_CONNECT_FAIL", OSW_ERROR_SERVER_CONNECT_FAIL);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SERVER_WORKER_EXIT_TIMEOUT", OSW_ERROR_SERVER_WORKER_EXIT_TIMEOUT);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SERVER_WORKER_ABNORMAL_PIPE_DATA", OSW_ERROR_SERVER_WORKER_ABNORMAL_PIPE_DATA);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_SERVER_WORKER_UNPROCESSED_DATA", OSW_ERROR_SERVER_WORKER_UNPROCESSED_DATA);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_OUT_OF_COROUTINE", OSW_ERROR_CO_OUT_OF_COROUTINE);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_HAS_BEEN_BOUND", OSW_ERROR_CO_HAS_BEEN_BOUND);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_HAS_BEEN_DISCARDED", OSW_ERROR_CO_HAS_BEEN_DISCARDED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_MUTEX_DOUBLE_UNLOCK", OSW_ERROR_CO_MUTEX_DOUBLE_UNLOCK);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_BLOCK_OBJECT_LOCKED", OSW_ERROR_CO_BLOCK_OBJECT_LOCKED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_BLOCK_OBJECT_WAITING", OSW_ERROR_CO_BLOCK_OBJECT_WAITING);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_YIELD_FAILED", OSW_ERROR_CO_YIELD_FAILED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_GETCONTEXT_FAILED", OSW_ERROR_CO_GETCONTEXT_FAILED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_SWAPCONTEXT_FAILED", OSW_ERROR_CO_SWAPCONTEXT_FAILED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_MAKECONTEXT_FAILED", OSW_ERROR_CO_MAKECONTEXT_FAILED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_IOCPINIT_FAILED", OSW_ERROR_CO_IOCPINIT_FAILED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_PROTECT_STACK_FAILED", OSW_ERROR_CO_PROTECT_STACK_FAILED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_STD_THREAD_LINK_ERROR", OSW_ERROR_CO_STD_THREAD_LINK_ERROR);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_DISABLED_MULTI_THREAD", OSW_ERROR_CO_DISABLED_MULTI_THREAD);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_CANNOT_CANCEL", OSW_ERROR_CO_CANNOT_CANCEL);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_NOT_EXISTS", OSW_ERROR_CO_NOT_EXISTS);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_CANCELED", OSW_ERROR_CO_CANCELED);
    OSW_REGISTER_LONG_CONSTANT("SWOOLE_ERROR_CO_TIMEDOUT", OSW_ERROR_CO_TIMEDOUT);
