...
#include "openswoole_socket_coro_arginfo.h"
...
zend_class_entry *openswoole_socket_coro_ce;
static zend_object_handlers openswoole_socket_coro_handlers;

static zend_class_entry *openswoole_socket_coro_exception_ce;
static zend_object_handlers openswoole_socket_coro_exception_handlers;
...
OSW_EXTERN_C_BEGIN
static PHP_METHOD(openswoole_socket_coro, __construct);
static PHP_METHOD(openswoole_socket_coro, bind);
static PHP_METHOD(openswoole_socket_coro, listen);
static PHP_METHOD(openswoole_socket_coro, accept);
static PHP_METHOD(openswoole_socket_coro, connect);
static PHP_METHOD(openswoole_socket_coro, checkLiveness);
static PHP_METHOD(openswoole_socket_coro, peek);
static PHP_METHOD(openswoole_socket_coro, recv);
static PHP_METHOD(openswoole_socket_coro, send);
static PHP_METHOD(openswoole_socket_coro, readVector);
static PHP_METHOD(openswoole_socket_coro, readVectorAll);
static PHP_METHOD(openswoole_socket_coro, writeVector);
static PHP_METHOD(openswoole_socket_coro, writeVectorAll);
static PHP_METHOD(openswoole_socket_coro, sendFile);
static PHP_METHOD(openswoole_socket_coro, recvAll);
static PHP_METHOD(openswoole_socket_coro, sendAll);
static PHP_METHOD(openswoole_socket_coro, recvPacket);
static PHP_METHOD(openswoole_socket_coro, recvLine);
static PHP_METHOD(openswoole_socket_coro, recvWithBuffer);
static PHP_METHOD(openswoole_socket_coro, recvfrom);
static PHP_METHOD(openswoole_socket_coro, sendto);
static PHP_METHOD(openswoole_socket_coro, getOption);
static PHP_METHOD(openswoole_socket_coro, setOption);
static PHP_METHOD(openswoole_socket_coro, setProtocol);
#ifdef OSW_USE_OPENSSL
static PHP_METHOD(openswoole_socket_coro, sslHandshake);
#endif
static PHP_METHOD(openswoole_socket_coro, shutdown);
static PHP_METHOD(openswoole_socket_coro, close);
static PHP_METHOD(openswoole_socket_coro, cancel);
static PHP_METHOD(openswoole_socket_coro, getsockname);
static PHP_METHOD(openswoole_socket_coro, getpeername);
OSW_EXTERN_C_END

// clang-format off


static const zend_function_entry openswoole_socket_coro_methods[] =
{
    PHP_ME(openswoole_socket_coro, __construct,   arginfo_class_OpenSwoole_Coroutine_Socket___construct,     ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, bind,          arginfo_class_OpenSwoole_Coroutine_Socket_bind,          ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, listen,        arginfo_class_OpenSwoole_Coroutine_Socket_listen,        ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, accept,        arginfo_class_OpenSwoole_Coroutine_Socket_accept,        ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, connect,       arginfo_class_OpenSwoole_Coroutine_Socket_connect,       ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, checkLiveness, arginfo_class_OpenSwoole_Coroutine_Socket_checkLiveness, ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, peek,          arginfo_class_OpenSwoole_Coroutine_Socket_peek,          ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, recv,          arginfo_class_OpenSwoole_Coroutine_Socket_recv,          ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, recvAll,       arginfo_class_OpenSwoole_Coroutine_Socket_recv,          ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, recvLine,      arginfo_class_OpenSwoole_Coroutine_Socket_recv,          ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, recvWithBuffer, arginfo_class_OpenSwoole_Coroutine_Socket_recv,         ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, recvPacket,    arginfo_class_OpenSwoole_Coroutine_Socket_recvPacket,    ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, send,          arginfo_class_OpenSwoole_Coroutine_Socket_send,          ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, readVector,    arginfo_class_OpenSwoole_Coroutine_Socket_readVector,    ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, readVectorAll, arginfo_class_OpenSwoole_Coroutine_Socket_readVectorAll, ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, writeVector,   arginfo_class_OpenSwoole_Coroutine_Socket_writeVector,   ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, writeVectorAll,arginfo_class_OpenSwoole_Coroutine_Socket_writeVectorAll, ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, sendFile,      arginfo_class_OpenSwoole_Coroutine_Socket_sendFile,      ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, sendAll,       arginfo_class_OpenSwoole_Coroutine_Socket_send,          ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, recvfrom,      arginfo_class_OpenSwoole_Coroutine_Socket_recvfrom,      ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, sendto,        arginfo_class_OpenSwoole_Coroutine_Socket_sendto,        ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, getOption,     arginfo_class_OpenSwoole_Coroutine_Socket_getOption,     ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, setProtocol,   arginfo_class_OpenSwoole_Coroutine_Socket_setProtocol,   ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, setOption,     arginfo_class_OpenSwoole_Coroutine_Socket_setOption,     ZEND_ACC_PUBLIC)
#ifdef OSW_USE_OPENSSL
    PHP_ME(openswoole_socket_coro, sslHandshake,  arginfo_class_OpenSwoole_Coroutine_Socket_sslHandshake,                      ZEND_ACC_PUBLIC)
#endif
    PHP_ME(openswoole_socket_coro, shutdown,      arginfo_class_OpenSwoole_Coroutine_Socket_shutdown,      ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, cancel,        arginfo_class_OpenSwoole_Coroutine_Socket_cancel,        ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, close,         arginfo_class_OpenSwoole_Coroutine_Socket_close,                      ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, getpeername,   arginfo_class_OpenSwoole_Coroutine_Socket_getpeername,                      ZEND_ACC_PUBLIC)
    PHP_ME(openswoole_socket_coro, getsockname,   arginfo_class_OpenSwoole_Coroutine_Socket_getsockname,                      ZEND_ACC_PUBLIC)
    PHP_FE_END
};
// clang-format on

#define OSW_BAD_SOCKET ((Socket *) -1)
#define openswoole_get_socket_coro(_sock, _zobject)                                                                        \
    SocketObject *_sock = php_openswoole_socket_coro_fetch_object(Z_OBJ_P(_zobject));                                      \
    if (UNEXPECTED(!sock->socket)) {                                                                                   \
        php_openswoole_fatal_error(E_ERROR, "you must call Socket constructor first");                                     \
    }                                                                                                                  \
    if (UNEXPECTED(_sock->socket == OSW_BAD_SOCKET)) {                                                                  \
        zend_update_property_long(openswoole_socket_coro_ce, OSW_Z8_OBJ_P(_zobject), ZEND_STRL("errCode"), EBADF);          \
        zend_update_property_string(                                                                                   \
            openswoole_socket_coro_ce, OSW_Z8_OBJ_P(_zobject), ZEND_STRL("errMsg"), strerror(EBADF));                       \
        RETURN_FALSE;                                                                                                  \
    }

static osw_inline SocketObject *php_openswoole_socket_coro_fetch_object(zend_object *obj) {
    return (SocketObject *) ((char *) obj - openswoole_socket_coro_handlers.offset);
}

static void php_openswoole_socket_coro_free_object(zend_object *object) {
    SocketObject *sock = (SocketObject *) php_openswoole_socket_coro_fetch_object(object);
    if (!sock->reference && sock->socket && sock->socket != OSW_BAD_SOCKET) {
        sock->socket->close();
        delete sock->socket;
    }
...
static zend_object *php_openswoole_socket_coro_create_object(zend_class_entry *ce) {
    ...
    sock->std.handlers = &openswoole_socket_coro_handlers;
    return &sock->std;
}

static void openswoole_socket_coro_register_constants(int module_number) {
...
void php_openswoole_socket_coro_minit(int module_number) {
    OSW_INIT_CLASS_ENTRY(openswoole_socket_coro, "OpenSwoole\\Coroutine\\Socket", nullptr, nullptr, openswoole_socket_coro_methods);
    OSW_SET_CLASS_NOT_SERIALIZABLE(openswoole_socket_coro);
    OSW_SET_CLASS_CLONEABLE(openswoole_socket_coro, osw_zend_class_clone_deny);
    OSW_SET_CLASS_UNSET_PROPERTY_HANDLER(openswoole_socket_coro, osw_zend_class_unset_property_deny);
    OSW_SET_CLASS_CUSTOM_OBJECT(openswoole_socket_coro,
                               php_openswoole_socket_coro_create_object,
                               php_openswoole_socket_coro_free_object,
                               SocketObject,
                               std);

    zend_declare_property_long(openswoole_socket_coro_ce, ZEND_STRL("fd"), -1, ZEND_ACC_PUBLIC);
    zend_declare_property_long(openswoole_socket_coro_ce, ZEND_STRL("domain"), 0, ZEND_ACC_PUBLIC);
    zend_declare_property_long(openswoole_socket_coro_ce, ZEND_STRL("type"), 0, ZEND_ACC_PUBLIC);
    zend_declare_property_long(openswoole_socket_coro_ce, ZEND_STRL("protocol"), 0, ZEND_ACC_PUBLIC);
    zend_declare_property_long(openswoole_socket_coro_ce, ZEND_STRL("errCode"), 0, ZEND_ACC_PUBLIC);
    zend_declare_property_string(openswoole_socket_coro_ce, ZEND_STRL("errMsg"), "", ZEND_ACC_PUBLIC);

    zend_declare_class_constant_long(openswoole_socket_coro_ce, ZEND_STRL("EVENT_READ"), OSW_EVENT_READ);
    zend_declare_class_constant_long(openswoole_socket_coro_ce, ZEND_STRL("EVENT_WRITE"), OSW_EVENT_READ);

    OSW_INIT_CLASS_ENTRY_EX(openswoole_socket_coro_exception,
                           "OpenSwoole\\Coroutine\\Socket\\Exception",
                           nullptr,
                           nullptr,
                           nullptr,
    ...
    if (!zend_hash_str_find_ptr(&module_registry, ZEND_STRL("sockets"))) {
        openswoole_socket_coro_register_constants(module_number);
    }
#ifdef ECANCELED
    OSW_REGISTER_LONG_CONSTANT("SOCKET_ECANCELED", ECANCELED);
#endif
}

static osw_inline void openswoole_socket_coro_sync_properties(zval *zobject, SocketObject *sock) {
    zend_update_property_long(openswoole_socket_coro_ce, OSW_Z8_OBJ_P(zobject), ZEND_STRL("errCode"), sock->socket->errCode);
    zend_update_property_string(openswoole_socket_coro_ce, OSW_Z8_OBJ_P(zobject), ZEND_STRL("errMsg"), sock->socket->errMsg);
}

static void osw_inline php_openswoole_init_socket(zval *zobject, SocketObject *sock) {
    sock->socket->set_zero_copy(true);
    sock->socket->set_buffer_allocator(osw_zend_string_allocator());
    zend_update_property_long(openswoole_socket_coro_ce, OSW_Z8_OBJ_P(zobject), ZEND_STRL("fd"), sock->socket->get_fd());
    zend_update_property_long(
        openswoole_socket_coro_ce, OSW_Z8_OBJ_P(zobject), ZEND_STRL("domain"), sock->socket->get_sock_domain());
    zend_update_property_long(
        openswoole_socket_coro_ce, OSW_Z8_OBJ_P(zobject), ZEND_STRL("type"), sock->socket->get_sock_type());
    zend_update_property_long(
        openswoole_socket_coro_ce, OSW_Z8_OBJ_P(zobject), ZEND_STRL("protocol"), sock->socket->get_sock_protocol());
}

OSW_API bool php_openswoole_export_socket(zval *zobject, Socket *_socket) {
    zend_object *object = php_openswoole_socket_coro_create_object(openswoole_socket_coro_ce);
    if (!object) {
        return false;
    }
    ...
    php_openswoole_init_socket(zobject, sock);
    return true;
}
...
OSW_API zend_object *php_openswoole_dup_socket(int fd, enum swSocketType type) {
    ...
    int new_fd = dup(fd);
    if (new_fd < 0) {
        php_openswoole_sys_error(E_WARNING, "dup(%d) failed", fd);
        return nullptr;
    }
    return php_openswoole_create_socket_from_fd(new_fd, type);
}
...
OSW_API Socket *php_openswoole_get_socket(zval *zobject) {
    OSW_ASSERT(Z_OBJCE_P(zobject) == openswoole_socket_coro_ce);
    SocketObject *sock = (SocketObject *) php_openswoole_socket_coro_fetch_object(Z_OBJ_P(zobject));
    return sock->socket;
}

OSW_API void php_openswoole_init_socket_object(zval *zobject, Socket *socket) {
    zend_object *object = php_openswoole_socket_coro_create_object(openswoole_socket_coro_ce);
    SocketObject *sock = (SocketObject *) php_openswoole_socket_coro_fetch_object(object);
    sock->socket = socket;
    ZVAL_OBJ(zobject, object);
...
OSW_API bool php_openswoole_socket_set_protocol(Socket *sock, zval *zset) {
     ...
     */
#ifdef OSW_USE_OPENSSL
    if (php_openswoole_array_get_value(vht, "open_ssl", ztmp)) {
        if (zval_is_true(ztmp)) {
            sock->enable_ssl_encrypt();
        }
    }
    if (sock->ssl_is_enable()) {
        if (!php_openswoole_socket_set_ssl(sock, zset)) {
            ret = false;
        }
    }
#endif
    ...
    if (php_openswoole_array_get_value(vht, "package_eof", ztmp)) {
        ...
        if (str_v.len() == 0) {
            ...
            ret = false;
        } else if (str_v.len() > OSW_DATA_EOF_MAXLEN) {
    ...
    if (php_openswoole_array_get_value(vht, "open_fastcgi_protocol", ztmp)) {
...
#define FCGI_MAX_LENGTH 0xffff
        ...
        sock->protocol.get_package_length =
            [](Protocol *protocol, openswoole::network::Socket *conn, const char *data, uint32_t size) {
    ...
    if (php_openswoole_array_get_value(vht, "open_mqtt_protocol", ztmp)) {
        sock->open_length_check = zval_is_true(ztmp);
        if (zval_is_true(ztmp)) {
            openswoole::mqtt::set_protocol(&sock->protocol);
        }
    }
    // open length check
    ...
    if (php_openswoole_array_get_value(vht, "package_length_type", ztmp)) {
        ...
        sock->protocol.package_length_size = openswoole_type_size(sock->protocol.package_length_type);
    ...
    if (php_openswoole_array_get_value(vht, "package_length_offset", ztmp)) {
        ...
        sock->protocol.package_length_offset = OSW_MAX(0, OSW_MIN(v, UINT16_MAX));
    }
    // package body start
    if (php_openswoole_array_get_value(vht, "package_body_offset", ztmp)) {
        zend_long v = zval_get_long(ztmp);
        sock->protocol.package_body_offset = OSW_MAX(0, OSW_MIN(v, UINT16_MAX));
    }
    // length function
        ...
        do {
            ...
            if (Z_TYPE_P(ztmp) == IS_STRING &&
                ...
                if (!osw_zend_is_callable_ex(ztmp, nullptr, 0, &func_name, nullptr, fci_cache, nullptr)) {
                    php_openswoole_fatal_error(E_WARNING, "function '%s' is not callable", func_name);
                    efree(func_name);
                    efree(fci_cache);
                    ret = false;
                    break;
                ...
                efree(func_name);
                sock->protocol.get_package_length = php_openswoole_length_func;
                if (sock->protocol.private_data) {
                    osw_zend_fci_cache_discard((zend_fcall_info_cache *) sock->protocol.private_data);
            ...
            sock->protocol.package_length_offset = OSW_IPC_BUFFER_SIZE;
        } while (0);
    }
    /**
     * package max length
    ...
    if (php_openswoole_array_get_value(vht, "package_max_length", ztmp)) {
        zend_long v = zval_get_long(ztmp);
        sock->protocol.package_max_length = OSW_MAX(0, OSW_MIN(v, UINT32_MAX));
    } else {
        sock->protocol.package_max_length = OSW_INPUT_BUFFER_SIZE;
    }
...
PHP_FUNCTION(openswoole_coroutine_socketpair) {
    ...
    if (0 != socketpair((int) domain, (int) type, (int) protocol, pair)) {
        php_openswoole_error(E_WARNING, "failed to create sockets: [%d]: %s", errno, strerror(errno));
        RETURN_FALSE;
    }

    php_openswoole_check_reactor();

    auto sock_type = openswoole::network::Socket::convert_to_type(domain, type, protocol);

    zend_object *s1 = php_openswoole_create_socket_from_fd(pair[0], sock_type);
    if (s1 == nullptr) {
        RETURN_FALSE;
    }

    zend_object *s2 = php_openswoole_create_socket_from_fd(pair[1], sock_type);
    if (s2 == nullptr) {
        OBJ_RELEASE(s1);
        RETURN_FALSE;
    }
...
static PHP_METHOD(openswoole_socket_coro, __construct) {
    ...
    SocketObject *sock = (SocketObject *) php_openswoole_socket_coro_fetch_object(Z_OBJ_P(ZEND_THIS));
    ...
    if (EXPECTED(!sock->socket)) {
        ...
        if (UNEXPECTED(sock->socket->get_fd() < 0)) {
            zend_throw_exception_ex(
                openswoole_socket_coro_exception_ce, errno, "new Socket() failed. Error: %s [%d]", strerror(errno), errno);
            delete sock->socket;
            sock->socket = nullptr;
            RETURN_FALSE;
        }
        php_openswoole_init_socket(ZEND_THIS, sock);
    }
}
...
static PHP_METHOD(openswoole_socket_coro, bind) {
    ...
    openswoole_get_socket_coro(sock, ZEND_THIS);

    if (!sock->socket->bind(std::string(address, l_address), port)) {
        openswoole_socket_coro_sync_properties(ZEND_THIS, sock);
        RETURN_FALSE;
    }
    RETURN_TRUE;
}
...
static PHP_METHOD(openswoole_socket_coro, accept) {
    ...
    if (conn) {
        zend_object *client = php_openswoole_socket_coro_create_object(openswoole_socket_coro_ce);
        SocketObject *client_sock = (SocketObject *) php_openswoole_socket_coro_fetch_object(client);
        ...
        php_openswoole_init_socket(return_value, client_sock);
    } else {
        openswoole_socket_coro_sync_properties(ZEND_THIS, sock);
        RETURN_FALSE;
    }
...
static PHP_METHOD(openswoole_socket_coro, connect) {
    ...
    if (sock->socket->get_sock_domain() == AF_INET6 || sock->socket->get_sock_domain() == AF_INET) {
        if (ZEND_NUM_ARGS() == 1) {
            php_openswoole_error(E_WARNING, "Socket of type AF_INET/AF_INET6 requires port argument");
            RETURN_FALSE;
        } else if (port == 0 || port >= 65536) {
            php_openswoole_error(E_WARNING, "Invalid port argument[" ZEND_LONG_FMT "]", port);
            RETURN_FALSE;
        }
    }
...
static PHP_METHOD(openswoole_socket_coro, peek) {
    zend_long length = OSW_BUFFER_SIZE_BIG;
    ...
    if (UNEXPECTED(bytes < 0)) {
        ...
        RETURN_STR(osw_zend_string_recycle(buf, length, bytes));
    }
}
...
static inline void openswoole_socket_coro_recv(INTERNAL_FUNCTION_PARAMETERS, RecvMode type) {
    zend_long length = OSW_BUFFER_SIZE_BIG;
    double timeout = 0;
...
static PHP_METHOD(openswoole_socket_coro, recv) {
    openswoole_socket_coro_recv(INTERNAL_FUNCTION_PARAM_PASSTHRU, SOCKET_RECV);
}

static PHP_METHOD(openswoole_socket_coro, recvAll) {
    openswoole_socket_coro_recv(INTERNAL_FUNCTION_PARAM_PASSTHRU, SOCKET_RECV_ALL);
}

static PHP_METHOD(openswoole_socket_coro, recvLine) {
    openswoole_socket_coro_recv(INTERNAL_FUNCTION_PARAM_PASSTHRU, SOCKET_RECV_LINE);
}

static PHP_METHOD(openswoole_socket_coro, recvWithBuffer) {
    openswoole_socket_coro_recv(INTERNAL_FUNCTION_PARAM_PASSTHRU, SOCKET_RECV_WITH_BUFFER);
}
...
static osw_inline void openswoole_socket_coro_send(INTERNAL_FUNCTION_PARAMETERS, const bool all) {
    char *data;
    size_t length;
    double timeout = 0;
...
static PHP_METHOD(openswoole_socket_coro, send) {
    openswoole_socket_coro_send(INTERNAL_FUNCTION_PARAM_PASSTHRU, false);
}

static void openswoole_socket_coro_write_vector(INTERNAL_FUNCTION_PARAMETERS, const bool all) {
    zval *ziov = nullptr;
    ...
    if (iovcnt > IOV_MAX) {
        osw_tg_buffer()->length = osw_snprintf(osw_tg_buffer()->str, osw_tg_buffer()->size, IOV_MAX_ERROR_MSG, IOV_MAX);
        sock->socket->set_err(EINVAL, osw_tg_buffer()->to_std_string());
        RETURN_FALSE;
    }

    std::unique_ptr<iovec[]> iov(new iovec[iovcnt]);

    OSW_HASHTABLE_FOREACH_START(vht, zelement)
    if (!ZVAL_IS_STRING(zelement)) {
        zend_throw_exception_ex(openswoole_socket_coro_exception_ce,
                                EINVAL,
    ...
    if (Z_STRLEN_P(zelement) == 0) {
        zend_throw_exception_ex(
            openswoole_socket_coro_exception_ce, EINVAL, "Item #[%d] cannot be empty string", iov_index);
        RETURN_FALSE;
    }
    ...
    openswoole::network::IOVector io_vector((struct iovec *) iov.get(), iovcnt);
...
static PHP_METHOD(openswoole_socket_coro, writeVector) {
    openswoole_socket_coro_write_vector(INTERNAL_FUNCTION_PARAM_PASSTHRU, false);
}

static PHP_METHOD(openswoole_socket_coro, writeVectorAll) {
    openswoole_socket_coro_write_vector(INTERNAL_FUNCTION_PARAM_PASSTHRU, true);
}

static void openswoole_socket_coro_read_vector(INTERNAL_FUNCTION_PARAMETERS, const bool all) {
    zval *ziov = nullptr;
    zval *zelement = nullptr;
    HashTable *vht;
    double timeout = 0;
    ...
    OSW_HASHTABLE_FOREACH_START(vht, zelement) {
        ...
        if (Z_LVAL_P(zelement) < 0) {
            zend_throw_exception_ex(
                openswoole_socket_coro_exception_ce, EINVAL, "Item #[%d] must be greater than 0", iov_index);
            RETURN_FALSE;
        }
    ...
    if (UNEXPECTED(retval < 0)) {
        ...
        if (retval < total_length) {
            ...
            iov[iov_index].iov_base = osw_zend_string_recycle(str, iov[iov_index].iov_len, offset_bytes)->val;
...
static PHP_METHOD(openswoole_socket_coro, readVector) {
    openswoole_socket_coro_read_vector(INTERNAL_FUNCTION_PARAM_PASSTHRU, false);
}

static PHP_METHOD(openswoole_socket_coro, readVectorAll) {
    openswoole_socket_coro_read_vector(INTERNAL_FUNCTION_PARAM_PASSTHRU, true);
}
...
static PHP_METHOD(openswoole_socket_coro, sendFile) {
    ...
    if (!sock->socket->sendfile(file, offset, length)) {
        zend_update_property_long(
            openswoole_socket_coro_ce, OSW_Z8_OBJ_P(ZEND_THIS), ZEND_STRL("errCode"), sock->socket->errCode);
        zend_update_property_string(
            openswoole_socket_coro_ce, OSW_Z8_OBJ_P(ZEND_THIS), ZEND_STRL("errMsg"), sock->socket->errMsg);
        RETVAL_FALSE;
    } else {
        RETVAL_TRUE;
    }
...
static PHP_METHOD(openswoole_socket_coro, sendAll) {
    openswoole_socket_coro_send(INTERNAL_FUNCTION_PARAM_PASSTHRU, true);
}
...
static PHP_METHOD(openswoole_socket_coro, recvfrom) {
    ...
    zend_string *buf = zend_string_alloc(OSW_BUFFER_SIZE_BIG, 0);
    Socket::TimeoutSetter ts(sock->socket, timeout, Socket::TIMEOUT_READ);
    ssize_t bytes = sock->socket->recvfrom(ZSTR_VAL(buf), OSW_BUFFER_SIZE_BIG);
    openswoole_socket_coro_sync_properties(ZEND_THIS, sock);
    if (bytes < 0) {
        zend_string_free(buf);
        RETURN_FALSE;
...
static PHP_METHOD(openswoole_socket_coro, close) {
    ...
    if (sock->socket->protocol.private_data) {
        ...
        osw_zend_fci_cache_discard(package_length_func);
        efree(package_length_func);
    }
    if (sock->socket->close()) {
        delete sock->socket;
        sock->socket = OSW_BAD_SOCKET;
    }
    RETURN_TRUE;
}
    ...
    if (level == IPPROTO_IP) {
        ...
        case IP_MULTICAST_IF: {
            ...
            if (_socket->get_option(level, optname, (char *) &if_addr, &optlen) != 0) {
                php_openswoole_sys_error(E_WARNING,
...
#define HANDLE_SUBCALL(res)                                                                                            \
    ...
    if (retval != 0) {
        php_openswoole_sys_error(E_WARNING, "setsockopt(%d) failed", sock->socket->get_fd());
        RETURN_FALSE;
    }
...
static PHP_METHOD(openswoole_socket_coro, cancel) {
    openswoole_get_socket_coro(sock, ZEND_THIS);
    zend_long event = OSW_EVENT_READ;
    ...
    RETURN_BOOL(sock->socket->cancel(event == OSW_EVENT_READ ? OSW_EVENT_READ : OSW_EVENT_WRITE));
}
...
static PHP_METHOD(openswoole_socket_coro, setProtocol) {
    ...
    if (php_openswoole_array_length(zset) == 0) {
        ...
        RETURN_BOOL(php_openswoole_socket_set_protocol(sock->socket, zset));
    }
}
