...
ZEND_BEGIN_ARG_INFO_EX(arginfo_class_Swoole_Coroutine_fread, 0, 0, 1)
    ZEND_ARG_INFO(0, handle)
    ZEND_ARG_INFO(0, length)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_Swoole_Coroutine_fgets, 0, 0, 1)
    ZEND_ARG_INFO(0, handle)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_Swoole_Coroutine_fwrite, 0, 0, 2)
    ZEND_ARG_INFO(0, handle)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Swoole_Coroutine_select, 0, 0, 1)
    ZEND_ARG_INFO(0, pull_chans)
    ZEND_ARG_INFO(0, push_chans)
    ZEND_ARG_INFO(0, timeout)
ZEND_END_ARG_INFO()
