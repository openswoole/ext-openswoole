...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(
    arginfo_class_Swoole_Http_Response_create, 0, 0, OpenSwoole\\Http\\Response, MAY_BE_BOOL)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(
    arginfo_class_Swoole_Http_Response_recv, 0, 0, OpenSwoole\\WebSocket\\Frame, MAY_BE_BOOL | MAY_BE_STRING)
