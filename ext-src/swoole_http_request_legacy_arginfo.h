...
ZEND_BEGIN_ARG_INFO_EX(arginfo_class_Swoole_Http_Request_create, 0, 0, 0)
ZEND_ARG_INFO(0, options)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_Swoole_Http_Request_parse, 0, 0, 1)
...
#define arginfo_class_Swoole_Http_Request_rawContent arginfo_swoole_http_void
