...
static const zend_function_entry swoole_socket_coro_methods[] =
{
    ...
    PHP_ME(swoole_socket_coro, recvAll,       arginfo_class_Swoole_Coroutine_Socket_recv,          ZEND_ACC_PUBLIC)
    PHP_ME(swoole_socket_coro, recvLine,      arginfo_class_Swoole_Coroutine_Socket_recv,          ZEND_ACC_PUBLIC)
    PHP_ME(swoole_socket_coro, recvWithBuffer, arginfo_class_Swoole_Coroutine_Socket_recv,         ZEND_ACC_PUBLIC)
    ...
    PHP_ME(swoole_socket_coro, sendAll,       arginfo_class_Swoole_Coroutine_Socket_send,          ZEND_ACC_PUBLIC)
