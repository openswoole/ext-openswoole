...
#include "swoole_redis_coro_arginfo.h"
#else
#include "swoole_redis_coro_legacy_arginfo.h"
#endif
...
{
    PHP_ME(swoole_redis_coro, __construct, arginfo_class_Swoole_Coroutine_Redis___construct, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, __destruct, arginfo_class_Swoole_Coroutine_Redis___destruct, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, connect, arginfo_class_Swoole_Coroutine_Redis_connect, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, getAuth, arginfo_class_Swoole_Coroutine_Redis_getAuth, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, getDBNum, arginfo_class_Swoole_Coroutine_Redis_getDBNum, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, getOptions, arginfo_class_Swoole_Coroutine_Redis_getOptions, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, setOptions, arginfo_class_Swoole_Coroutine_Redis_setOptions, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, getDefer, arginfo_class_Swoole_Coroutine_Redis_getDefer, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, setDefer, arginfo_class_Swoole_Coroutine_Redis_setDefer, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, recv, arginfo_class_Swoole_Coroutine_Redis_recv, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, request, arginfo_class_Swoole_Coroutine_Redis_request, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, close, arginfo_class_Swoole_Coroutine_Redis_close, ZEND_ACC_PUBLIC)
    /*---------------------Redis Command------------------------*/
    PHP_ME(swoole_redis_coro, set, arginfo_class_Swoole_Coroutine_Redis_set, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, setBit, arginfo_class_Swoole_Coroutine_Redis_setBit, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, setEx, arginfo_class_Swoole_Coroutine_Redis_setEx, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, psetEx, arginfo_class_Swoole_Coroutine_Redis_psetEx, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, lSet, arginfo_class_Swoole_Coroutine_Redis_lSet, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, get, arginfo_class_Swoole_Coroutine_Redis_get, ZEND_ACC_PUBLIC)

    PHP_ME(swoole_redis_coro, mGet, arginfo_class_Swoole_Coroutine_Redis_mGet, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, del, arginfo_class_Swoole_Coroutine_Redis_del, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, hDel, arginfo_class_Swoole_Coroutine_Redis_hDel, ZEND_ACC_PUBLIC)

    PHP_ME(swoole_redis_coro, hSet, arginfo_class_Swoole_Coroutine_Redis_hSet, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, hMSet, arginfo_class_Swoole_Coroutine_Redis_hMSet, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, hSetNx, arginfo_class_Swoole_Coroutine_Redis_hSetNx, ZEND_ACC_PUBLIC)

    PHP_MALIAS(swoole_redis_coro, delete, del, arginfo_class_Swoole_Coroutine_Redis_del, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, mSet, arginfo_class_Swoole_Coroutine_Redis_mSet, ZEND_ACC_PUBLIC)

    PHP_ME(swoole_redis_coro, mSetNx, arginfo_class_Swoole_Coroutine_Redis_mSetNx, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, getKeys, arginfo_class_Swoole_Coroutine_Redis_getKeys, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, keys, getKeys, arginfo_class_Swoole_Coroutine_Redis_getKeys, ZEND_ACC_PUBLIC)

    PHP_ME(swoole_redis_coro, exists, arginfo_class_Swoole_Coroutine_Redis_exists, ZEND_ACC_PUBLIC)


    PHP_ME(swoole_redis_coro, type, arginfo_class_Swoole_Coroutine_Redis_type, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, strLen, arginfo_class_Swoole_Coroutine_Redis_strLen, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, lPop, arginfo_class_Swoole_Coroutine_Redis_lPop, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, blPop, arginfo_class_Swoole_Coroutine_Redis_blPop, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, rPop, arginfo_class_Swoole_Coroutine_Redis_rPop, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, brPop, arginfo_class_Swoole_Coroutine_Redis_brPop, ZEND_ACC_PUBLIC)

    PHP_ME(swoole_redis_coro, bRPopLPush, arginfo_class_Swoole_Coroutine_Redis_bRPopLPush, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, lSize, arginfo_class_Swoole_Coroutine_Redis_lSize, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, lLen, lSize, arginfo_class_Swoole_Coroutine_Redis_lLen, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, sSize, arginfo_class_Swoole_Coroutine_Redis_sSize, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, scard, sSize, arginfo_class_Swoole_Coroutine_Redis_scard, ZEND_ACC_PUBLIC)

    PHP_ME(swoole_redis_coro, sPop, arginfo_class_Swoole_Coroutine_Redis_sPop, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, sMembers, arginfo_class_Swoole_Coroutine_Redis_sMembers, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, sGetMembers, sMembers, arginfo_class_Swoole_Coroutine_Redis_sGetMembers, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, sRandMember, arginfo_class_Swoole_Coroutine_Redis_sRandMember, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, persist, arginfo_class_Swoole_Coroutine_Redis_persist, ZEND_ACC_PUBLIC)

    PHP_ME(swoole_redis_coro, ttl, arginfo_class_Swoole_Coroutine_Redis_ttl, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, pttl, arginfo_class_Swoole_Coroutine_Redis_pttl, ZEND_ACC_PUBLIC)

    PHP_ME(swoole_redis_coro, zCard, arginfo_class_Swoole_Coroutine_Redis_zCard, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, zSize, zCard, arginfo_class_Swoole_Coroutine_Redis_zSize, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, hLen, arginfo_class_Swoole_Coroutine_Redis_hLen, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, hKeys, arginfo_class_Swoole_Coroutine_Redis_hKeys, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, hVals, arginfo_class_Swoole_Coroutine_Redis_hVals, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, hGetAll, arginfo_class_Swoole_Coroutine_Redis_hGetAll, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, debug, arginfo_class_Swoole_Coroutine_Redis_debug, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, restore, arginfo_class_Swoole_Coroutine_Redis_restore, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, dump, arginfo_class_Swoole_Coroutine_Redis_dump, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, renameKey, arginfo_class_Swoole_Coroutine_Redis_renameKey, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, rename, renameKey, arginfo_class_Swoole_Coroutine_Redis_rename, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, renameNx, arginfo_class_Swoole_Coroutine_Redis_renameNx, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, rpoplpush, arginfo_class_Swoole_Coroutine_Redis_rpoplpush, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, randomKey, arginfo_class_Swoole_Coroutine_Redis_randomKey, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, pfadd, arginfo_class_Swoole_Coroutine_Redis_pfadd, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, pfcount, arginfo_class_Swoole_Coroutine_Redis_pfcount, ZEND_ACC_PUBLIC)

    PHP_ME(swoole_redis_coro, pfmerge, arginfo_class_Swoole_Coroutine_Redis_pfmerge, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, ping, arginfo_class_Swoole_Coroutine_Redis_ping, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, auth, arginfo_class_Swoole_Coroutine_Redis_auth, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, unwatch, arginfo_class_Swoole_Coroutine_Redis_unwatch, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, watch, arginfo_class_Swoole_Coroutine_Redis_watch, ZEND_ACC_PUBLIC)

    PHP_ME(swoole_redis_coro, save, arginfo_class_Swoole_Coroutine_Redis_save, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, bgSave, arginfo_class_Swoole_Coroutine_Redis_bgSave, ZEND_ACC_PUBLIC)

    PHP_ME(swoole_redis_coro, lastSave, arginfo_class_Swoole_Coroutine_Redis_lastSave, ZEND_ACC_PUBLIC)

    PHP_ME(swoole_redis_coro, flushDB, arginfo_class_Swoole_Coroutine_Redis_flushDB, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, flushAll, arginfo_class_Swoole_Coroutine_Redis_flushAll, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, dbSize, arginfo_class_Swoole_Coroutine_Redis_dbSize, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, bgrewriteaof, arginfo_class_Swoole_Coroutine_Redis_bgrewriteaof, ZEND_ACC_PUBLIC)

    PHP_ME(swoole_redis_coro, time, arginfo_class_Swoole_Coroutine_Redis_time, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, role, arginfo_class_Swoole_Coroutine_Redis_role, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, setRange, arginfo_class_Swoole_Coroutine_Redis_setRange, ZEND_ACC_PUBLIC)

    PHP_ME(swoole_redis_coro, setNx, arginfo_class_Swoole_Coroutine_Redis_setNx, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, getSet, arginfo_class_Swoole_Coroutine_Redis_getSet, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, append, arginfo_class_Swoole_Coroutine_Redis_append, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, lPushx, arginfo_class_Swoole_Coroutine_Redis_lPushx, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, lPush, arginfo_class_Swoole_Coroutine_Redis_lPush, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, rPush, arginfo_class_Swoole_Coroutine_Redis_rPush, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, rPushx, arginfo_class_Swoole_Coroutine_Redis_rPushx, ZEND_ACC_PUBLIC)

    PHP_ME(swoole_redis_coro, sContains, arginfo_class_Swoole_Coroutine_Redis_sContains, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, sismember, sContains, arginfo_class_Swoole_Coroutine_Redis_sContains, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zScore, arginfo_class_Swoole_Coroutine_Redis_zScore, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zRank, arginfo_class_Swoole_Coroutine_Redis_zRank, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zRevRank, arginfo_class_Swoole_Coroutine_Redis_zRevRank, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, hGet, arginfo_class_Swoole_Coroutine_Redis_hGet, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, hMGet, arginfo_class_Swoole_Coroutine_Redis_hMGet, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, hExists, arginfo_class_Swoole_Coroutine_Redis_hExists, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, publish, arginfo_class_Swoole_Coroutine_Redis_publish, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zIncrBy, arginfo_class_Swoole_Coroutine_Redis_zIncrBy, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zAdd, arginfo_class_Swoole_Coroutine_Redis_zAdd, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zPopMin, arginfo_class_Swoole_Coroutine_Redis_zPopMin, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zPopMax, arginfo_class_Swoole_Coroutine_Redis_zPopMax, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, bzPopMin, arginfo_class_Swoole_Coroutine_Redis_bzPopMin, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, bzPopMax, arginfo_class_Swoole_Coroutine_Redis_bzPopMax, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zDeleteRangeByScore, arginfo_class_Swoole_Coroutine_Redis_zDeleteRangeByScore, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, zRemRangeByScore, zDeleteRangeByScore, arginfo_class_Swoole_Coroutine_Redis_zRemRangeByScore, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zCount, arginfo_class_Swoole_Coroutine_Redis_zCount, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zRange, arginfo_class_Swoole_Coroutine_Redis_zRange, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zRevRange, arginfo_class_Swoole_Coroutine_Redis_zRevRange, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zRangeByScore, arginfo_class_Swoole_Coroutine_Redis_zRangeByScore, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zRevRangeByScore, arginfo_class_Swoole_Coroutine_Redis_zRevRangeByScore, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zRangeByLex, arginfo_class_Swoole_Coroutine_Redis_zRangeByLex, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zRevRangeByLex, arginfo_class_Swoole_Coroutine_Redis_zRevRangeByLex, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zInter, arginfo_class_Swoole_Coroutine_Redis_zInter, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, zinterstore, zInter, arginfo_class_Swoole_Coroutine_Redis_zinterstore, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zUnion, arginfo_class_Swoole_Coroutine_Redis_zUnion, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, zunionstore, zUnion, arginfo_class_Swoole_Coroutine_Redis_zunionstore, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, incrBy, arginfo_class_Swoole_Coroutine_Redis_incrBy, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, hIncrBy, arginfo_class_Swoole_Coroutine_Redis_hIncrBy, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, incr, arginfo_class_Swoole_Coroutine_Redis_incr, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, decrBy, arginfo_class_Swoole_Coroutine_Redis_decrBy, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, decr, arginfo_class_Swoole_Coroutine_Redis_decr, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, getBit, arginfo_class_Swoole_Coroutine_Redis_getBit, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, lInsert, arginfo_class_Swoole_Coroutine_Redis_lInsert, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, lGet, arginfo_class_Swoole_Coroutine_Redis_lGet, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, lIndex, lGet, arginfo_class_Swoole_Coroutine_Redis_lIndex, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, setTimeout, arginfo_class_Swoole_Coroutine_Redis_setTimeout, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, expire, setTimeout, arginfo_class_Swoole_Coroutine_Redis_setTimeout, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, pexpire, arginfo_class_Swoole_Coroutine_Redis_setTimeout, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, expireAt, arginfo_class_Swoole_Coroutine_Redis_setTimeout, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, pexpireAt, arginfo_class_Swoole_Coroutine_Redis_setTimeout, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, move, arginfo_class_Swoole_Coroutine_Redis_move, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, select, arginfo_class_Swoole_Coroutine_Redis_select, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, getRange, arginfo_class_Swoole_Coroutine_Redis_getRange, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, listTrim, arginfo_class_Swoole_Coroutine_Redis_listTrim, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, ltrim, listTrim, arginfo_class_Swoole_Coroutine_Redis_listTrim, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, lGetRange, arginfo_class_Swoole_Coroutine_Redis_lGetRange, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, lRange, lGetRange, arginfo_class_Swoole_Coroutine_Redis_lRange, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, lRem, arginfo_class_Swoole_Coroutine_Redis_lRem, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, lRemove,lRem, arginfo_class_Swoole_Coroutine_Redis_lRem, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zDeleteRangeByRank, arginfo_class_Swoole_Coroutine_Redis_zDeleteRangeByRank, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, zRemRangeByRank, zDeleteRangeByRank, arginfo_class_Swoole_Coroutine_Redis_zDeleteRangeByRank, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, incrByFloat, arginfo_class_Swoole_Coroutine_Redis_incrByFloat, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, hIncrByFloat, arginfo_class_Swoole_Coroutine_Redis_hIncrByFloat, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, bitCount, arginfo_class_Swoole_Coroutine_Redis_bitCount, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, bitOp, arginfo_class_Swoole_Coroutine_Redis_bitOp, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, sAdd, arginfo_class_Swoole_Coroutine_Redis_sAdd, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, sMove, arginfo_class_Swoole_Coroutine_Redis_sMove, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, sDiff, arginfo_class_Swoole_Coroutine_Redis_sDiff, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, sDiffStore, arginfo_class_Swoole_Coroutine_Redis_sDiffStore, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, sUnion, arginfo_class_Swoole_Coroutine_Redis_sUnion, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, sUnionStore, arginfo_class_Swoole_Coroutine_Redis_sUnionStore, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, sInter, arginfo_class_Swoole_Coroutine_Redis_sInter, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, sInterStore, arginfo_class_Swoole_Coroutine_Redis_sInterStore, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, sRemove, arginfo_class_Swoole_Coroutine_Redis_sRemove, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, srem, sRemove, arginfo_class_Swoole_Coroutine_Redis_sRemove, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, zDelete, arginfo_class_Swoole_Coroutine_Redis_zDelete, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, zRemove, zDelete, arginfo_class_Swoole_Coroutine_Redis_zDelete, ZEND_ACC_PUBLIC)
    PHP_MALIAS(swoole_redis_coro, zRem, zDelete, arginfo_class_Swoole_Coroutine_Redis_zDelete, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, pSubscribe, arginfo_class_Swoole_Coroutine_Redis_pSubscribe, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, subscribe, arginfo_class_Swoole_Coroutine_Redis_subscribe, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, unsubscribe, arginfo_class_Swoole_Coroutine_Redis_unsubscribe, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, pUnSubscribe, arginfo_class_Swoole_Coroutine_Redis_pUnSubscribe, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, multi, arginfo_class_Swoole_Coroutine_Redis_multi, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, exec, arginfo_class_Swoole_Coroutine_Redis_exec, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, eval, arginfo_class_Swoole_Coroutine_Redis_eval, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, evalSha, arginfo_class_Swoole_Coroutine_Redis_evalsha, ZEND_ACC_PUBLIC)
    PHP_ME(swoole_redis_coro, script, arginfo_class_Swoole_Coroutine_Redis_script, ZEND_ACC_PUBLIC)
    /*---------------------Redis Command End------------------------*/
    PHP_FE_END
};
// clang-format on
