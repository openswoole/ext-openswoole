...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_class_Swoole_Coroutine_Http2_Client_stats,
                                        0,
                                        0,
                                        MAY_BE_BOOL | MAY_BE_ARRAY | MAY_BE_LONG)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_class_Swoole_Coroutine_Http2_Client_send,
                                        0,
                                        1,
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(
    arginfo_class_Swoole_Coroutine_Http2_Client_recv, 0, 0, OpenSwoole\\Http2\\Response, MAY_BE_BOOL)
...
ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(
    0, errorCode, IS_LONG, 0, "OpenSwoole\\Coroutine\\Http2\\Client::HTTP2_ERROR_NO_ERROR")
